...
const CONVERSATION_RUNTIME_VERSION = "agent-workspace-conversation-v3";
...
function agentWorkspaceConversationRuntimeSource() {
  return [
    ...
    `const METHOD="linux-agent-workspace";let seq=0,pending=new Map,state={panel:null,media:null,title:null,meta:null,stop:null,revoke:null,refresh:null,error:null,activeId:null,visible:false,pollTimer:null,viewTimer:null,viewObserver:null,screenshotTimer:null,busy:false,lastImage:""};`,
