...
const CONVERSATION_RUNTIME_VERSION = "agent-workspace-conversation-v8";
...
function workspaceViewerThemeOverrides(){return"/* codex-linux-agent-workspace-theme-v8 */"+
...
".codex-linux-agent-workspace-empty{color:var(--color-token-text-secondary,var(--color-token-description-foreground,var(--text-secondary,var(--token-description-foreground,#aaa))))}.codex-linux-agent-workspace-meta{margin:6px 8px 8px;padding:6px 30px 6px 9px;border:1px solid var(--color-token-border-default,var(--token-border-default,rgba(127,127,127,.16)));border-radius:var(--radius-md,6px);background:color-mix(in srgb,var(--color-token-main-surface-primary,var(--token-main-surface-primary,#fff)) 54%,transparent);color:var(--color-token-text-secondary,var(--color-token-description-foreground,var(--text-secondary,var(--token-description-foreground,#aaa))));font-size:var(--text-xs,11px);line-height:1.25;letter-spacing:0}.codex-linux-agent-workspace-error{margin:0 8px 8px;padding:7px 9px;border:1px solid color-mix(in srgb,var(--color-red-500,#ef4444) 28%,transparent);border-radius:var(--radius-md,6px);background:color-mix(in srgb,var(--color-red-500,#ef4444) 10%,transparent);color:var(--color-token-text-primary,var(--text-primary,#fff));white-space:normal}"+
...
function installInteractions(){let style=document.getElementById("codex-linux-agent-workspace-style");if(style&&!style.textContent.includes("codex-linux-agent-workspace-theme-v8"))style.textContent+=workspaceViewerThemeOverrides();state.head?.addEventListener("pointerdown",event=>beginInteraction("move",event));state.resize?.addEventListener("pointerdown",event=>beginInteraction("resize",event));window.addEventListener("resize",()=>{if(state.layout)setPanelLayout(state.layout,!0)})}
