...
PY
    ...
    assert_contains "$REPO_DIR/launcher/start.sh.template" 'ELECTRON_RENDERER_URL="$WEBVIEW_ORIGIN/"'
...
test_side_by_side_launcher_identity() {
    ...
    assert_contains "$app_dir/start.sh" 'ELECTRON_RENDERER_URL="$WEBVIEW_ORIGIN/"'
